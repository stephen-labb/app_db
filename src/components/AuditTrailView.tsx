        ...
        <div className="p-4 sm:p-6 border-b border-slate-200 dark:border-slate-800 flex flex-col lg:flex-row items-center justify-between gap-4">
          ...
          <div className="relative w-full lg:w-96">
            ...
            <input
              ...
              placeholder="Search across user, component, action, target, or compliance tag..."
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50 dark:bg-slate-950/60 border-b border-slate-200 dark:border-slate-800 text-[11px] font-bold text-slate-500 uppercase tracking-wider">
                ...
                <th className="py-3.5 px-4">Log Details & Compliance Tag</th>
                ...
                filteredRecords.map((record) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Change Log Details & Compliance Tag */}
                      <td className="py-3.5 px-4 max-w-xs sm:max-w-md">
                        <p className="text-slate-700 dark:text-slate-300 line-clamp-2">
                          {record.details}
                        </p>
                        <div className="mt-1 flex items-center gap-1.5">
                          <span className="px-1.5 py-0.5 rounded bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 text-[9px] font-mono border border-slate-200 dark:border-slate-700">
                            {record.complianceTag}
                          </span>
                        </div>
                      </td>
        ...
        <div className="fixed inset-0 z-50 bg-slate-950/70 backdrop-blur-xs flex items-center justify-center p-4 animate-fadeIn">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-2xl w-full p-6 text-white shadow-2xl space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 text-xs bg-slate-950/80 p-4 rounded-xl border border-slate-800">
              ...
              <div>
                <p className="text-slate-500 font-semibold uppercase">Compliance Control Mapping</p>
                <p className="font-mono text-emerald-400 mt-0.5">{inspectingRecord.complianceTag}</p>
              </div>
            </div>
